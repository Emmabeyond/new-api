...
import SettingsPaymentGatewayLinuxDo from '../../pages/Setting/Payment/SettingsPaymentGatewayLinuxDo';
  ...
  return (
    <>
      <Spin spinning={loading} size='large'>
        ...
        <Card style={{ marginTop: '10px' }}>
          <SettingsPaymentGatewayLinuxDo options={inputs} refresh={onRefresh} />
        </Card>
      </Spin>
    </>
  );
