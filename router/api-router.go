	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/pay/qrcode", middleware.CriticalRateLimit(), controller.RequestEpayQRCode)
				selfRoute.GET("/topup/status", controller.GetOrderStatus)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/topup/export", controller.ExportTopUps)
				adminRoute.GET("/topup/:topup_id", controller.GetTopUpDetail)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/batch", controller.BatchGetOptions)
			optionRoute.PUT("/batch", controller.BatchUpdateOptions)
		...
		logRoute.GET("/search", middleware.AdminAuth(), middleware.LogQueryRateLimit(), controller.SearchAllLogs)
		logRoute.GET("/self", middleware.UserAuth(), middleware.LogQueryRateLimit(), controller.GetUserLogs)
		logRoute.GET("/self/search", middleware.UserAuth(), middleware.LogQueryRateLimit(), controller.SearchUserLogs)
